...
class Ui_Zap_Step1(object):
    def setupUi(self, Zap_Step1):
        ...
        self.radioButton_no.setGeometry(QtCore.QRect(340, 260, 82, 17))
        ...
        self.radioButton_no.setIconSize(QtCore.QSize(16, 16))
        ...
        self.radioButton_female_2 = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButton_female_2.setGeometry(QtCore.QRect(450, 460, 82, 21))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.radioButton_female_2.setFont(font)
        self.radioButton_female_2.setObjectName("radioButton_female_2")
    ...
    def retranslateUi(self, Zap_Step1):
        ...
        self.radioButton_no.setText(_translate("Zap_Step1", "М"))
        ...
        self.radioButton_female_2.setText(_translate("Zap_Step1", "Нет"))
